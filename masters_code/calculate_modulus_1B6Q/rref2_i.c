...
int rref2_i(float matrix[][3], float young[], float poisson[], int n, int res, int testnode, int testframe, int t){
...
*/
  ...
  */
  ...
  /* We have two unkowns for isotropic material */
  young[0]   = 1 / matrix[0][2];            // E = 1/a = 1/(1/E)
  poisson[0] = matrix[1][2] / matrix[0][2]; // v = b/a = (v/E) / (1/E)
  if(res== testnode && testframe == t){
    printf("\n The solved matrix for node %d is:\n", res+1);
    printf("%f %f %f \n",matrix[0][0],matrix[0][1],matrix[0][2]);
    printf("%f %f %f \n",matrix[1][0],matrix[1][1],matrix[1][2]);
    printf("young[0] = %f poisson[0] = %f \n", young[0], poisson[0]);
    getchar();
  }
