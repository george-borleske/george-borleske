...
int readpsf(char rep2[][10], char des2[][10], char amino2[][10], float mass2[], float charge2[], int bond_nodes[][2], int angle_nodes[][3], int dihedral_nodes[][4], char psf_name[]) {
...
*/
  ...
  */
  ...
  // printf("number of angle bonds = %d \n", i);
/*
  for(i=0;i<75;i++){
